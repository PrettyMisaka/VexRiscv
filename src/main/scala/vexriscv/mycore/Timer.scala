...
case class Timer(width : Int) extends Component{
  ...
  def driveFrom(busCtrl : BusSlaveFactory,baseAddress : BigInt)
    ...
    //Address C => auto reload enable
    busCtrl.driveAndRead( io.autoReload, baseAddress + 12) init(false)
