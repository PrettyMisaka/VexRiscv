...
void SD_Test(void)
{
  ...
  {    
    // println("SD卡初始化失败，请确保SD卡已正确接入开发板，或换一张SD卡测试！");
    println("sdcard init error!");		 
  }
  else
  {
    // println("SD卡初始化成功！");		 
    println("sdcard init success!");		 
  }
...
{  
  ...
  {
    // println("Single block 测试成功！");
    println("Single block test success！");

  }
  else
  {
    // println("Single block 测试失败，请确保SD卡正确接入开发板，或换一张SD卡测试！");
    println("Single block test error");
...
{  
  ...
  {
    // println("Multi block 测试成功！");
    println("Multi block test success！");

  }
  else
  {
    // println("Multi block 测试失败，请确保SD卡正确接入开发板，或换一张SD卡测试！");
    println("Multi block test error!");
  }
}
